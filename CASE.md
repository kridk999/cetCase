HYPOTHESIS:
    * Identify micro-fluctuations based on short-term supply and demand imbalances

DATA ANALYSIS:
    * Look for spreads on different market stages based on supply/demand imbalances to see if they can be exploitet for a strategy
